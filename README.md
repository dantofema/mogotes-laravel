...
[![Total Downloads](https://img.shields.io/packagist/dt/dantofema/mogotes-laravel.svg?style=flat-square)](https://packagist.org/packages/dantofema/mogotes-laravel)

This is where your description should go. Limit it to a paragraph or two. Consider adding a small example.

## Support us

[<img src="https://github-ads.s3.eu-central-1.amazonaws.com/mogotes-laravel.jpg?t=1" width="419px" />](https://spatie.be/github-ad-click/mogotes-laravel)
...
```bash
php artisan vendor:publish --tag="mogotes-laravel-migrations"
php artisan migrate
```
...
```bash
php artisan vendor:publish --tag="mogotes-laravel-views"
```

## Usage

```php
$mogotesLaravel = new Dantofema\MogotesLaravel();
echo $mogotesLaravel->echoPhrase('Hello, Dantofema!');
```
